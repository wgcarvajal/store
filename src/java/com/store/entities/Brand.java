 ...
 */
@Entity
@Table(name = "brand", catalog = "storebd", schema = "")
@XmlRootElement
@NamedQueries({
    @NamedQuery(name = "Brand.findAll", query = "SELECT b FROM Brand b"),
    @NamedQuery(name = "Brand.findByBrandId", query = "SELECT b FROM Brand b WHERE b.brandId = :brandId"),
    @NamedQuery(name = "Brand.findByColumn", query = "SELECT b FROM Brand b WHERE LOWER(b.brandName) LIKE :brandName Order by b.brandName asc"),
