...
public class PriceController implements Serializable {
    ...
    @EJB
    private com.store.facade.PriceFacade ejbFacade;
    ...
    public Price getPrice(java.lang.Long id) {
    ...
    public static class PriceControllerConverter implements Converter {
        ...
        public String getAsString(FacesContext facesContext, UIComponent component, Object object) {
            ...
            if (object instanceof Price) {
                ...
                return getStringKey(o.getPriceId());
            } else {
                Logger.getLogger(this.getClass().getName()).log(Level.SEVERE, "object {0} is of type {1}; expected type: {2}", new Object[]{object, object.getClass().getName(), Price.class.getName()});
                return null;
            }
        }
